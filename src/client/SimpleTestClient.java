...
public class SimpleTestClient
{
   public static void main(String args[])
   {
	   ...
	   SwingUtilities.invokeLater(new Runnable() {
			@Override
			public void run() {
				new GameEngineCallbackGUI(new GameEngineImpl());
			}
		});
      ...
      //testClient.testMultiplePlayers();
      //testClient.testInvalidBet();
     // testClient.testMultipleGEC();
     // testClient.testRemovePlayer();
      //testClient.testIfResetBet();
      //testClient.testAddSamePlayerId();
     // testClient.testMultipleRounds();
      //testClient.testBetMoreThenPoints();
      //testClient.testHalfDeckCreationMethod();
   }
